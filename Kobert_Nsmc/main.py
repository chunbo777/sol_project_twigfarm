...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_dir", default="/home/tutor/seojiwon/bert/KoBERT-nsmc/data/model", type=str, help="Path to save, load model")
    parser.add_argument("--data_dir", default="/home/tutor/", type=str, help="The input data dir")
    parser.add_argument("--train_file", default="data_bert/AIhub_train.csv", type=str, help="Train file")
    parser.add_argument("--test_file", default="data_bert/AIhub_test.csv", type=str, help="Test file")
    # parser.add_argument("--train_file", default="/home/tutor/seojiwon/bert/KoBERT-nsmc/data/ratings_train.txt", type=str, help="Train file")
    # parser.add_argument("--test_file", default="/home/tutor/seojiwon/bert/KoBERT-nsmc/data/ratings_test.txt", type=str, help="Test file")
